...
function form(){?>
 ...
 echo image("logo.png",200,400)?>
	...
	<a href=<?php
 echo "$rooturl/login.php";?> target="_blank">Login</a><br>
	<a href=<?php
 echo "$rooturl/help.html";?> target="_blank">Help Page</a><br>
	<a href=<?php
 echo "$rooturl/TASKS/Motif_Enrichment/view.php?jobid=TEV0sE&email=guest&handle=guest";?> target="_blank">Sample Output(AR_LNCAP)</a> <br>
	</div>
