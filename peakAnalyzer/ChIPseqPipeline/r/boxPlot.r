# main
# Grab command line argument. Usage: R --vanilla --args commonPeakIntensities="commonPath" uniquePeakIntensities="uniquePath" firstLegend="legend1" secondLegend="legend2" boxPlotFile="outpath" < rscript path
...
png(boxPlotFile)
#boxplot(list(common=x, unique=y), ylab = "peak intensity", col="orange")
q1 <- quantile(x)
q2 <- quantile(y)
...
boxplot(list(common=x_filtered, unique=y_filtered), ylab = "peak intensity", col="orange")
