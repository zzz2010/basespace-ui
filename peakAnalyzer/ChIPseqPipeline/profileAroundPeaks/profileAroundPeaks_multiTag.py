...
for tagdata in sys.argv[3:]:
	...
	cmd="java -cp "+toolpath+"../LGL/LGL.jar LGL.shortReads.ProfileRegion2 "+tagdata+" "+peakdata+"  "+toolpath+"./profile_10bp_200bins.txt "+outdir+"/"+tagname+"_around_"+peakname+".aroundPeaks"
