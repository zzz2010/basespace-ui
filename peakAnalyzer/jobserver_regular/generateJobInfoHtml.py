...
pkfileurl=''
download_btn='<a style="padding-bottom:20px;" target="_blank" href="'+pkfileurl+'"><button class="btn btn-primary" type="submit">Download Peak File <span class="icon-download icon-white"></span></button></a>'
