...
def generateMappingStats(result_dir):
    ...
    try:
        ...
        num_reads_html='<tr><td>Number of Reads</td><td>'+num_unmap+'</td><td>'+num_mm +'</td><td>'+num_uniq+'</td><td>'+num_pcr+'</td><td><span class="label label-important">'+num_total+'</span></td></tr>'
