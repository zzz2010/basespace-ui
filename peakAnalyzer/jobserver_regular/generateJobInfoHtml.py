...
def generatePkCallingStats(result_dir):
    ...
    macs_version='1.4.2'
    macs_info='<style> #table_macs td{text-align:center;width:50%} tr td:FIRST-CHILD{font-weight:bold;}</style> <table id="table_macs" class="table table-bordered table-condensed"><tr><td colspan="2"><strong>MACS Arguments</strong></td></tr>\
