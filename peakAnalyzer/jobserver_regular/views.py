...
def denovoMotif_result(dir1):
    ...
    html_button='<a target="_blank" style="padding-bottom:50px;" id="download" href="'+pwm_result +'"><button class="btn btn-primary" type="submit">Download PWM Result</button></a>'
