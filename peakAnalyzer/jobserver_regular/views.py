...
#    html_str+="});</script>\n"
    ...
    html_str="<div class='tab-pane' id='"+os.path.basename(dir1)+"'><object id='iFrame1' name='iFrame1'  width='100%' onload='this.height=iFrame1.document.body.scrollHeight' frameborder='0'  data='/~sokemay/Motif_Enrichment/viewresult_peakAnalyzer.php?rundir="+dir1+"' type='text/html'></object></div>\n"
