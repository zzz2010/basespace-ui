...
def denovoMotif_result(dir1):
    ...
    html_button='<a style="padding-left:100px;padding-top:20px" id="download" href="'+pwm_result +'"><button class="btn btn-primary" type="submit">Download PWM Result</button></a>'
