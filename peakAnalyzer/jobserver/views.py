...
#    html_str+="});</script>\n"
    html_str="<div class='tab-pane' id='"+os.path.basename(dir1)+"""'><iframe 
    width="100%" onload="this.height=iFrame1.document.body.scrollHeight" frameborder="0" 
    src='http://genome.ddns.comp.nus.edu.sg/~chipseq/webseqtools2/TASKS/Motif_Enrichment/viewresult.php
    ?rundir="""+dir1+"'></iframe></div>\n"
